<h2> 1248 20
1439. Find the Kth Smallest Sum of a Matrix With Sorted Rows</h2><hr><div><p>You are given an <code>m x n</code> matrix <code>mat</code> that has its rows sorted in non-decreasing order and an integer <code>k</code>.</p>
