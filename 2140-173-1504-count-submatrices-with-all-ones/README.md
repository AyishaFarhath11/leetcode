<h2> 2140 173
1504. Count Submatrices With All Ones</h2><hr><div><p>Given an <code>m x n</code> binary matrix <code>mat</code>, <em>return the number of <strong>submatrices</strong> that have all ones</em>.</p>
